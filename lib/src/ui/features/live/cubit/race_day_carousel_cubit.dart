...
class RaceDayCarouselCubit extends Cubit<RaceDayCarouselState> {
  RaceDayCarouselCubit({required RaceDayType currentRaceDay, required RaceDayType selectedRaceDay})
    : super(RaceDayCarouselLoaded(currentRaceDay: currentRaceDay, selectedRaceDay: selectedRaceDay));
  ...
  void selectCurrentRaceDay() {
    emit(state.copyWith(selectedRaceDay: state.currentRaceDay));
  }
}
