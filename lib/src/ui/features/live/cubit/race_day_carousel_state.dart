...
sealed class RaceDayCarouselState extends Equatable {
  const RaceDayCarouselState({required this.currentRaceDay, required this.selectedRaceDay});
  ...
  RaceDayCarouselState copyWith({RaceDayType? selectedRaceDay, RaceDayType? currentRaceDay});
}

final class RaceDayCarouselLoaded extends RaceDayCarouselState {
  const RaceDayCarouselLoaded({required super.currentRaceDay, super.selectedRaceDay = RaceDayType.prep});
