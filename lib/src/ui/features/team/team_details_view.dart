...
class TeamDetailsView extends StatefulWidget {
  ...
  TeamDetailsView({super.key}) : teamMembers = _getTeamMembers();
  final List<TeamMember> teamMembers;

  @override
  State<TeamDetailsView> createState() => _TeamDetailsViewState();

  static List<TeamMember> _getTeamMembers() {
    return <TeamMember>[
      TeamMember(
        imageUrl:
      ...
      TeamMember(
        ...
        description: (BuildContext context) =>
            context.l10n.descriptionDaanDeJong,
      ...
      TeamMember(
        ...
        description: (BuildContext context) =>
            context.l10n.descriptionRoosmarijn,
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    widget.teamMembers[_currentIndex]
                        .getDescriptionText(context),
